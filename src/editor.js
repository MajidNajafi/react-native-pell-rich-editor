...
<head>
    ...
    <style>
        * {outline: 0px solid transparent;-webkit-tap-highlight-color: rgba(0,0,0,0);-webkit-touch-callout: none;}
        ...
        .content {  font-family: Arial, Helvetica, sans-serif;color: #000033; width: 100%;height: 300px;-webkit-overflow-scrolling: touch;padding-left: 0;padding-right: 0;}
        .pell { height: 100%;background-color: #ddd}
